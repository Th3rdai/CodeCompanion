...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      NSMicrophoneUsageDescription:
        "Code Companion uses the microphone for voice dictation to transcribe speech into text fields.",
    },
  },
  dmg: {
  ...
  afterAllArtifactBuild: path.join(
    __dirname,
    "scripts",
    "linux-gpg-after-artifact.js",
  ),
};
