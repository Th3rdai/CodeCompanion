...
- **Code Review with Report Card** — color-coded letter grades (A-F) for bugs, security, readability, and completeness with conversational deep-dives. **Scan Folder** tab for reviewing entire project folders at once. Attach bug screenshots to provide visual evidence
...
| **Diagram**              | Describe a system, process, or relationship and get a Mermaid diagram (flowchart, sequence, ER, etc.). Includes zoom controls, fullscreen preview, light/dark diagram theme toggle, and export as Source, SVG, or PNG.               |
...
| **Review**               | Full code report card with letter grades (A–F) for bugs, security, readability, and completeness. **Scan Folder** tab for reviewing entire project folders at once. Export as Markdown or JSON.                                      |
...
- In **Diagram** mode (or any mode where the AI returns a Mermaid diagram), each diagram has controls for **Preview**, **Light/Dark diagram theme**, **Source** (raw Mermaid), **SVG**, and **PNG**.
