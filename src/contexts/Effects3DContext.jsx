...
export const THEME_PRESETS = [
  { id: 'indigo-night',    label: 'Indigo Night',    primary: '#6366f1', secondary: '#a855f7', tertiary: '#60a5fa', hue: 239 },
  { id: 'emerald-matrix',  label: 'Emerald Matrix',  primary: '#10b981', secondary: '#34d399', tertiary: '#6ee7b7', hue: 160 },
  { id: 'sunset-blaze',    label: 'Sunset Blaze',    primary: '#f97316', secondary: '#fb923c', tertiary: '#fbbf24', hue: 25 },
  { id: 'cherry-blossom',  label: 'Cherry Blossom',  primary: '#ec4899', secondary: '#f472b6', tertiary: '#a78bfa', hue: 330 },
  { id: 'arctic-blue',     label: 'Arctic Blue',     primary: '#0ea5e9', secondary: '#38bdf8', tertiary: '#7dd3fc', hue: 199 },
];
...
export function Effects3DProvider({ children }) {
  ...
  const theme = customHue !== null && themeId.startsWith('custom')
  ...
  useEffect(() => {
    ...
    if (customHue !== null) {
      try { localStorage.setItem(HUE_KEY, String(customHue)); } catch {}
    }
  ...
  function selectPreset(id) {
    setCustomHue(null);
    setThemeId(id);
    try { localStorage.removeItem(HUE_KEY); } catch {}
  }

  return (
    <Effects3DContext.Provider value={{ enabled, setEnabled, theme, setThemeId: selectPreset, customHue, setCustomHue: applyHue }}>
      {children}
