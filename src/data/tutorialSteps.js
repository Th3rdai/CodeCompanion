...
export const BUILD_TUTORIAL_STEPS = [
  {
    ...
    prefill: {
      name: 'My First Build',
      description: 'A small app or tool I want to plan and build step by step using GSD (planning) and ICM (stages).',
    },
  },
  {
    title: 'Audience & Tone',
...
export const CREATE_TUTORIAL_STEPS = [
  {
    ...
    prefill: {
      ...
      description: 'A project to draft and refine blog posts with an AI writing assistant.',
