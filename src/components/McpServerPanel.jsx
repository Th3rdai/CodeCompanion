...
const ALL_TOOLS = [
  {
    ...
    name: "Chat",
    desc: "General conversational mode for PMs",
  },
  {
    id: "codecompanion_explain",
    name: "Explain Code",
    desc: "Explains code in plain English",
  },
  {
    id: "codecompanion_find_bugs",
    name: "Find Bugs",
    desc: "Reviews code for bugs and security issues",
  },
  {
    id: "codecompanion_refactor",
    name: "Refactor",
    desc: "Suggests refactoring improvements",
  },
  {
    id: "codecompanion_tech_to_biz",
    name: "Tech → Business",
    desc: "Translates technical content to business language",
  },
  {
    id: "codecompanion_biz_to_tech",
    name: "Business → Tech",
    desc: "Translates business requirements to tech specs",
  },
  {
    id: "codecompanion_list_models",
    name: "List Models",
    desc: "Lists available Ollama models",
  },
  {
    id: "codecompanion_get_status",
    name: "Get Status",
    desc: "Returns connection status and configuration",
  },
  {
    id: "codecompanion_browse_files",
    name: "Browse Files",
    desc: "Lists the project file tree",
  },
  {
    id: "codecompanion_read_file",
    name: "Read File",
    desc: "Reads a file from the project folder",
  },
  {
    id: "codecompanion_list_conversations",
    name: "List Conversations",
    desc: "Lists saved conversation history",
  },
];
    ...
    <div className="space-y-5">
      ...
      <div className="p-4 glass rounded-lg border border-slate-700/30">
        ...
        <div className="flex items-center gap-2 mb-3">
          <div
            className={`w-2.5 h-2.5 rounded-full ${enabled ? "bg-green-400" : "bg-red-400"}`}
          />
          <span
            className={`text-sm ${enabled ? "text-green-400" : "text-red-400"}`}
          >
          ...
          <div className="space-y-2.5">
            <div>
              ...
              <div className="flex items-center gap-2 bg-slate-800/50 rounded-lg px-3 py-2">
                <code className="flex-1 text-xs text-indigo-300 font-mono">
                  https://localhost:8900/mcp
                </code>
            ...
            <div>
              ...
              {expandedConfig && (
                <div className="mt-2 bg-slate-800/50 rounded-lg p-3 relative">
                  ...
                  <CopyButton
                    text={JSON.stringify(claudeDesktopConfig, null, 2)}
                  />
                </div>
              )}
            </div>
        ...
        <div className="space-y-2">
          {ALL_TOOLS.map((tool) => {
            ...
            return (
              <div
                key={tool.id}
                className="flex items-center justify-between p-2.5 rounded-lg hover:bg-slate-700/20 transition-colors"
              >
        ...
        <div className="p-4 glass rounded-lg border border-slate-700/30">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-indigo-400">
                {stats.lastCallAt
                  ? new Date(stats.lastCallAt).toLocaleTimeString()
                  : "—"}
              </div>
