...
const BINARY_EXTENSIONS = new Set([
  // Images
  ".jpg", ".jpeg", ".png", ".gif", ".bmp", ".ico", ".webp", ".tiff", ".tif", ".avif", ".heic",
  // Audio / video
  ".mp3", ".mp4", ".wav", ".ogg", ".flac", ".aac", ".mov", ".avi", ".mkv", ".webm",
  // Archives
  ".zip", ".tar", ".gz", ".bz2", ".xz", ".rar", ".7z", ".dmg", ".pkg", ".deb", ".rpm",
  // Executables / compiled
  ".exe", ".dll", ".so", ".dylib", ".app", ".bin", ".class", ".pyc", ".pyo", ".o", ".obj", ".a",
  // Fonts
...
function buildFileTree(folder, maxDepth) {
  function walkDir(dirPath, depth) {
    ...
    for (const entry of entries) {
      if (entry.name.startsWith(".") && !ALLOW_DOTNAMES.has(entry.name)) continue;
