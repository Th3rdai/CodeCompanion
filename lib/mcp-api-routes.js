...
function createMcpApiRoutes(deps) {
  ...
  router.post('/mcp/clients/test-connection', async (req, res) => {
    ...
    try {
      const tools = await mcpClientManager.connect(tempConfig);
  ...
  router.post('/mcp/clients', (req, res) => {
    ...
    const newClient = { id, name, transport, command, args, env, url, autoConnect: autoConnect || false, disabledTools: [] };
