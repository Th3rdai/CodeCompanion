...
const BUILTIN_TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      'Requires "model" (Ollama model name or "auto") and either "code" (full source string) or "sourcePath" (file path under the project folder). ' +
  ...
  },
  {
    ...
    description:
      "Security scan of a folder under the project folder (same file caps as Security mode). " +
      'Args: {"model": "auto", "folder": "src"} — folder is relative to the project root or absolute within it.',
    requiresAppSkill: "pentest",
    parallelSafe: false,
  },
  {
...
- builtin.review_run — Same AI review as Review mode. Pass model + code or sourcePath under the project folder.
- builtin.pentest_scan — Single-file OWASP-style security scan (not remediation). Model + code or sourcePath.
- builtin.pentest_scan_folder — Folder scan under the project folder only; respects the same size/file limits as Security mode.
