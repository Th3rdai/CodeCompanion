 ...
 * @param {boolean} [opts.preferToolCapable] — prefer a model known to support TOOL_CALL: patterns (agent tools active)
...
async function resolveAutoModel(opts) {
  ...
  // Cloud-proxied models generally don't support this format — swap to a capable local model.
