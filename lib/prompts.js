...
5. **Stop conditions** — Stop and summarize clearly when: the success metric is met; you are blocked twice on the same action; there is no progress after two similar attempts; or the user should take manual action (secrets, network, hardware).
6. **Structured step summary** — End each assistant turn with a short block:
\`\`\`
### Step summary
- **Did:** …
- **Observed:** …
- **Next:** … | **Done** (if finished)
\`\`\`
