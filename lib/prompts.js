...
(What's unclear or needs product decision?)` + MODE_GUARDRAIL,
  ...
  create: `You are Th3rdAI Code Companion helping a Product Manager scaffold a new AI-assisted project workspace.
Use the Create wizard in the UI to set up your project. If you prefer to describe your project in chat, I can help guide you — but the wizard is the fastest path.`
};
