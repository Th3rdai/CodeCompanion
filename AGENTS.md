...
This project is indexed by GitNexus as **CodeCompanion** (1172 symbols, 2761 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
