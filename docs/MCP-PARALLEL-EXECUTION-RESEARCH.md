...
From the backlog: _"leverage Code Companion MCP server for parallel task execution. No implementation spec yet — research + design first."_
...
### 2.4 What _is_ already parallel (for context)
