...
test.describe("ReviewPanel Input Methods", () => {
  ...
  test("should render three input method tabs", async ({ page }) => {
    ...
    await expect(
      page.getByRole("tab", { name: /browse files/i }),
    ).toBeVisible();
  });
  ...
  test("should display code textarea in Paste tab", async ({ page }) => {
    ...
    await expect(
      page.getByPlaceholder("Paste your code here..."),
    ).toBeVisible();
  ...
  test("should display file browser trigger in Browse tab", async ({
    page,
  }) => {
    await page.getByRole("tab", { name: /browse files/i }).click();
    await expect(
      page.getByText(/browse files from your project folder/i),
    ).toBeVisible();
