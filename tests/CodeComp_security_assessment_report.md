...
[
  {
    "id": "ab3c6cbb",
    "title": "{mcpServers: archon, ip: HOST_IP:8051}",
    "mode": "refactor"
  },
  {
    "id": "8f07293e",
    "title": "Is it possible to inspect and review binaries?",
    "mode": "chat"
  },
  {
    "id": "44a79176",
...
const API_KEY =
  process.env.APP_API_KEY || crypto.randomBytes(32).toString("hex");
...
_Report generated: 2026-03-14 | Assessor: Agent Zero Security | Target: http://HOST_IP:3000/ | Scope: High-level black-box assessment_
