...
human_verification:
  ...
  - test: "Copy to clipboard — click any Copy button in ClaudeCodeHandoff"
    expected: "Toast shows 'Copied!' and clipboard contains the exact th3rdai-harness command string"
...
**Phase Goal:** Full project dashboard for Build mode — list projects, view phases/plans, run th3rdai-harness commands, AI research/planning, advanced view, handoff and polish
**Verified:** 2026-03-15
...
| 10  | User sees copy-pasteable th3rdai-harness slash commands for Claude Code handoff               | VERIFIED | ClaudeCodeHandoff.jsx (145 lines) renders contextual `/harness:plan-phase`, `/harness:execute-phase`, `/harness:verify-work`, `/harness:research-phase` commands based on project state |
...
| `src/components/ClaudeCodeHandoff.jsx`  | Copy-pasteable th3rdai-harness commands panel (min 40 lines)          | VERIFIED | 145 lines; contextual command list, navigator.clipboard copy, toast feedback             |
...
| P5-01       | 16-04-PLAN.md | Handoff shows copy-pasteable th3rdai-harness commands | SATISFIED (human needed) | ClaudeCodeHandoff.jsx with navigator.clipboard; clipboard result needs human             |
...
**Expected:** Toast shows "Copied!" and the clipboard contains the exact command string shown (e.g., `/harness:plan-phase 1`).
