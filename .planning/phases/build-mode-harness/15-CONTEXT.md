# Phase 15: Build Mode (th3rdai-harness) — Context
...
| th3rdai-harness + skills in scaffold | Embedded in build-scaffolder; skills/harness-workflows.md | Done   |

## Requirements

- BUILD-01: Build mode in tabs; wizard scaffolds .planning/ + stages/
- BUILD-02: CLAUDE.md, CONTEXT.md, skills/harness-workflows.md; usable in Cursor/Claude Code
