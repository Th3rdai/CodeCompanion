...
This project is indexed by GitNexus as **CodeCompanion** (3106 symbols, 5524 relationships, 180 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
