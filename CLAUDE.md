...
This project is indexed by GitNexus as **AIApp-CodeCompanion** (1012 symbols, 2241 relationships, 74 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
