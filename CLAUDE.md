...
This project is indexed by GitNexus as **CodeCompanion** (1163 symbols, 2753 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
